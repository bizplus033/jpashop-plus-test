package com.study.jpashop.repository.order.query;
...
public class OrderQueryRepository {
    ...
    private List<OrderItemQueryDto> findOrderItems(Long orderId) {
        return em.createQuery(
                "select new com.study.jpashop.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    public List<OrderFlatDto> findAllByDto_flat() {
        return em.createQuery(
                "select new com.study.jpashop.repository.order" +
